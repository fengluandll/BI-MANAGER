...
<script type="text/javascript" src="${request.contextPath}/static/static/h-ui/js/H-ui.js"></script>
<script type="text/javascript" src="${request.contextPath}/static/static/h-ui.admin/js/H-ui.admin.page.js"></script> 
